...
results = model.val(data='/content/cropped-number-9/data.yaml')

# Perform object detection on a local image file
# Replace 'path/to/your/image.jpg' with the actual file path to your image
results = model('/content/cropped-number-9/test/images/101_jpg.rf.da8989ae3b8bb6cba2f31165e0c85ae2.jpg')
